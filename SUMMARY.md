...
* [Introducció React](README.md)

## Components

* [JSX](components/jsx.md)
* [Components i propietats](components/components-i-propietats.md)
* [Renderitzat condicional](components/renderitzat-condicional.md)
* [Llistes i claus](components/llistes-i-claus.md)

## Hooks

* [State i useState](hooks/state-i-usestate.md)
* [Efectes i UseEffect](hooks/efectes-i-useeffect.md)
...
* [Axios amb React](consultes-http-i-api/axios-amb-react.md)

## Events i Formularis

* [Events](events-i-formularis/events.md)
...
* [Outlet](react-router/outlet/README.md)
  * [Exemple nested routes + outlet](react-router/outlet/exemple-nested-routes-+-outlet.md)

## SPA - Single Page Application

* [SPA](spa-single-page-application/spa.md)
* [Redux](spa-single-page-application/redux.md)
